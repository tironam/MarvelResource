  ...
  return (
    <div className="container-fluid">
      ...
      <div className="row text-center">
        ...
        <UpcomingShow
          id="secretinvasion"
          poster="https://terrigen-cdn-dev.marvel.com/content/prod/1x/secretinvasion_lob_crd_02.jpg"
        ...
        <UpcomingShow
          id="ironheart"
          poster="https://terrigen-cdn-dev.marvel.com/content/prod/1x/ironheart_lob_crd_02.jpg"
