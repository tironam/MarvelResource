...
const Footer = () => {
    const modalText = ["As a web developer, turning my passion for Marvel into my next web development project was a no-brainer! There are new Marvel fans everyday, so I wanted to create a simple resource that would have all the basic information they might want, and answer some major questions to important questions. I've really enjoyed making this site and will continue to keep it updated as new information comes along!", <br />, <br />, "My motivation to create this site was primarily to further my skills as a web developer. The technologies I used for this site are HTML, CSS, React.JS, Reactstrap, Fontawesome, and react-scroll-up-button. Feel free to check out my portfolio site linked down here! It will have all of my contact info. I'd love to work with you and I'm always willing to learn something new! Can't wait to hear from you."]
