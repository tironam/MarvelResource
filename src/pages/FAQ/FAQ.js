    ...
    return (
        <div className="Container">
            ...
            <div className="text">
                ...
                <Button size="lg" className="phaseBtn phase1 navColor" color="danger" href="#Oldmarvelshows" style={{ marginBottom: '1rem' }}>
                    The Old Marvel Shows
                </Button>
                <Button size="lg" className="phaseBtn phase1 navColor" color="danger" href="#Disney" style={{ marginBottom: '1rem' }}>
                    Marvel & Theme Parks
                </Button>
            </div>
